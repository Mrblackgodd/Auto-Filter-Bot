...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6803055931:AAHB2j5YdwXO_qhR9RwMcb8ie_rvgdCJyhI')
if len(BOT_TOKEN) == 0:
...
# for chatGPT
OPENAI_API = environ.get('OPENAI_API', 'AIzaSyDvqDthwpxAhMu-Ms35-EJ14s_6T2MloZA')
if len(OPENAI_API) == 0:
    print('Info - OPENAI_API is empty')

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Getosugru:nehalsingh969797@cluster0.1wypan9.mongodb.net/?retryWrites=true&w=majority")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001943196163")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://auto-filter-bot-g7d3.onrender.com")
if len(URL) == 0:
